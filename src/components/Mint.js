...
function Mint({mint})
{
    return (
        ...
        <tbody>
          <tr><td align='right'>Amount:</td><td><input value='12.1234' type='number' id='mint-amount-number' /><select id='mint-amount-select'><option value='ZEOS'>ZEOS</option></select></td></tr>
